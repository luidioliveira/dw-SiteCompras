...
@WebServlet(name = "ListaEletrodomesticos", urlPatterns = {"/ListaEletrodomesticos"})
public class ListaEletrodomesticos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Produto> meusProdutos= produto_dao.ListarEletrodomesticos();
