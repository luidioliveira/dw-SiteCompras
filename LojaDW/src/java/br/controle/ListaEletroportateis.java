...
@WebServlet(name = "ListaEletroportateis", urlPatterns = {"/ListaEletroportateis"})
public class ListaEletroportateis extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Produto> meusProdutos= produto_dao.ListarEletroportateis();
